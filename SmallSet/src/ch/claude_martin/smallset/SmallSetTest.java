...
public class SmallSetTest {
  ...
  public void testContainsAll() throws Exception {
    ...
    for (Alphabet a1 : alphabet) {
      ...
      assertTrue(az.containsAll(Arrays.asList(a1.ordinal())));
      for (Alphabet a2 : alphabet) {
        assertTrue(az.containsAll(EnumSet.of(a1, a2)));
        assertTrue(az.containsAll(Arrays.asList(a1.ordinal(), a2.ordinal())));
      }
      assertFalse(empty().containsAll(EnumSet.of(a1)));
      assertFalse(empty().containsAll(Arrays.asList(a1.ordinal())));
    }
  ...
  public void testForEach() throws Exception {
    ...
    of(1, 2, 3).forEach(set::add);
    assertEquals(of(1, 2, 3).toSet(), set);

    set.clear();
    empty().complement().forEach(set::add);
    assertEquals(empty().complement().toSet(), set);
  ...
  public void testStream() throws Exception {
    ...
    TreeSet<Integer> expected = new TreeSet<>(asList(0, 5, 10, 15, 20, 25, 30));
    {
